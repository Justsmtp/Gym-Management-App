...
const PaymentScreen = () => {
  ...
  const handlePaystackPayment = async () => {
    ...
    try {
      ...
      // Use backend type (name) not displayName
      ...
      // FIXED: Define callback function separately with proper context
      ...
      // FIXED: Define onClose separately
      ...
      // Open Paystack popup with properly defined callbacks
        ...
        <div className="bg-white rounded-2xl shadow-lg p-4 md:p-6 border-2 border-gray-200 mb-4 md:mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            {Object.keys(membershipPlans).map((key) => {
              ...
              const displayText = plan.displayName || plan.name;
